    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.grupos.index') }}" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 hover:bg-blue-50 transition">
                ...
                <a href="{{ route('admin.horarios.index') }}" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 hover:bg-blue-50 transition">
                    <h4 class="font-bold text-gray-800 dark:text-gray-100">Asignar Horarios</h4>
                    <p class="text-gray-500 text-sm mt-1">Asignar docentes, aulas y horarios a grupos</p>
                </a>
